...
<div class="fl-container">
    ...
    <div class="fl-bg" style="padding:0 2rem 3rem 2rem">
        <div class="fl-bg-white pad-2-5" style="border-radius:1.4rem;">
            <p class="fl-color bold ft-24 m-0">ACTIVITY RESCHEDULED</p>
            <p class="ft-26 mb-10">Hi Sauban Ahmad,</p>
            <p class="m-0">You have successfully rescheduled your Furlenco activity.<br/>Your request completion date is <b>xx/xx/xx.</b></p>
        </div>
    </div>
    <div class="pad-2-5">
